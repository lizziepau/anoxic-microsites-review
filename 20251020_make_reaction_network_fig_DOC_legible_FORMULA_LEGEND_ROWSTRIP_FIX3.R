...
# ===================================================================
# ROWSTRIP (FIX3): subset node layer data instead of using filter=
# ===================================================================
library(tidyverse)
...
ggsave("reaction_network_redox_DOC_legible_FORMULA_LEGEND_ROWSTRIP_FIX3.svg", plate, width = FIG_W, height = FIG_H)
ggsave("reaction_network_redox_DOC_legible_FORMULA_LEGEND_ROWSTRIP_FIX3.png", plate, width = FIG_W, height = FIG_H, dpi = 600)
