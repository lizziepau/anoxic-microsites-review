...
# ======================================================================
# make_interface_redox_network_pH3_9_DOC_3x3_FIXZEROLEN.R
...
if ("pH" %in% names(edges)) {
  edges <- edges %>% mutate(pH_band = cut(pH, breaks = c(3,5,7,9),
...
} else stop("Edges must include pH or pH_band.")
...
# ---- FIX: remove zero-length and NA endpoints to prevent calcCurveGrob errors ----
